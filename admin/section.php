        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
              <h6 class="m-0 font-weight-bold text-white">Registered Sections</h6>
                <div class="dropdown no-arrow">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#sectionRegister">
                    ...
                    <?php
                      ...
                      if (mysqli_num_rows($result)>0) { 
                        while ($row = $result->fetch_assoc()) {
                          ...
                          echo "
                          <tr>
                            <td class='section_id' hidden>".$row['id']."</td>
                            <td><a href='#' class='btn btn-primary btn-sm section_edit'><i class='fas fa-edit fa-fw'></i> Edit</a></td>
                            <td>".$row['sec_name']."</td>
                            <td>".$row['sec_id']."</td>
                            <td>".$row['dept_id']."</td>
                            <td><center/>".$label."</td>
