            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
              <h6 class="m-0 font-weight-bold text-white">Registered Departments</h6>
                <div class="dropdown no-arrow">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#departmentRegister">
                    ...
                    <?php
                      ...
                      if (mysqli_num_rows($result)>0) { 
                        while ($row = $result->fetch_assoc()) {
                          $dept_id = $row['dept_id'];
                          $count = mysqli_query($con, "SELECT COUNT(id) as count_under_section FROM section WHERE dept_id='$dept_id'");
                          ...
                          echo "
                          <tr>
                            <td class='department_id' hidden>".$row['id']."</td>
                            <td><a href='#' class='btn btn-primary btn-sm department_edit'><i class='fas fa-edit fa-fw'></i> Edit</a></td>
                            <td>".$row['dept_name']."</td>
                            <td>".$row['dept_id']."</td>
                            <td>".$count_row['count_under_section']."</td>
                            <td><center/>".$label."</td>
                          </tr>";
                        }
                      }
